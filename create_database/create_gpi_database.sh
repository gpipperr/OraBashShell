...
#
#####################################################################
#  Database Installer for a new Database, Works with Oracle 11g, 12c, until 19c
#  
#  Version 20
#
####################################################################
...
if [ "${DB_RELEASE}" = "12c" ]  ||  [ "${DB_RELEASE}" = "19c" ]; then
...
# Call dbconsole if 12c/19c 
if [ "${DB_RELEASE}" = "12c" ] ||  [ "${DB_RELEASE}" = "19c" ]; then
	printLine "setup ${DB_RELEASE} DBConsole"
